# User stories — Peigne et bla-bla

Site vitrine pour Alicia, coiffeuse à domicile.
...
- En tant que Visiteur, je veux voir la zone d'intervention sur une carte, dans le but de vérifier si mon adresse est couverte.
- En tant que Visiteur, je veux consulter les avis Google, dans le but de me faire un avis sur la qualité des prestations.
- En tant que Visiteur, je veux remplir un formulaire de contact, dans le but de poser une question sans passer par le téléphone.
- En tant que Visiteur, je veux que le site s'affiche correctement sur mon téléphone, dans le but de le consulter facilement en mobilité.